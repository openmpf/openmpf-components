...
TEST(KEYWORDTAGGING, DateTest) {
    ...
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "5 JAN 2023","date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "09 FEB 1998", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "30 SEP, 1982", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "21 NOV., 1994", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "01 JAN. 3012", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "11 Feb 2012", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "31 March 2090", "date"));
    ...
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "Sept. 5 th", "Sept.; Sept. 5 th", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "Sept 20 2024", "Sept 20; Sept 20 2024", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "Sep 20 2024", "Sep 20; Sep 20 2024", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "Sep. 20 2024", "Sep. 20; Sep. 20 2024", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "September 20 2024", "September 20; September 20 2024", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "September 20th 2024", "September 20; September 20th 2024", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "Sept. 20th 2024", "Sept. 20; Sept. 20th 2024", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "January 1 1988", "January; January 1 1988", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "September 20th", "September 20; September 20th", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "Sept 1st", "Sept; Sept 1st", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "Sep 2nd", "Sep; Sep 2nd", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "Sep. 3rd", "Sep.; Sep. 3rd", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "September 4th", "September; September 4th", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "Sept. 5th", "Sept.; Sept. 5th", "date"));
    ...
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "JAN 5 2023", "JAN; JAN 5 2023", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "FEB 09 1998", "FEB 09; FEB 09 1998", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "MAR 14 24", "MAR 14; MAR 14 24", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "APR 1 00", "APR; APR 1 00", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "SEP 30, 1982", "SEP 30; SEP 30, 1982", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "NOV. 21, 1994",  "NOV. 21; NOV. 21, 1994", "date"));
    ASSERT_NO_FATAL_FAILURE(assertTextAndTagFound(tagger, "JAN. 01 3012",  "JAN. 01; JAN. 01 3012", "date"));

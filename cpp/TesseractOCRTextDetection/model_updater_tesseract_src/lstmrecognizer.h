...
class LSTMRecognizer {
 public:
  ...
  // on the unicharset matching. This enables model_updater_tesseract_src to deserialize a model
 ...
 protected:
  ...
  STRING network_str_;
  // Flags used to determine the model_updater_tesseract_src method of the network.
  // See enum TrainingFlags above.
  int32_t training_flags_;
  // Number of actual backward model_updater_tesseract_src steps used.
  int32_t training_iteration_;
  // Index into model_updater_tesseract_src sample set. sample_iteration >= training_iteration_.

...
// Other features used for model_updater_tesseract_src the adaptive classifier, but not used
// during normal model_updater_tesseract_src, therefore not in the DescDefs array.

 ...
 * fields must contain integers which identify the model_updater_tesseract_src
 ...
 * model_updater_tesseract_src set.  All CharID fields must be between 0 and
 * NumChar-1.  The main function of this routine is to help
 * identify clusters which need to be split further, i.e. if
 * numerous model_updater_tesseract_src characters have 2 or more features which are

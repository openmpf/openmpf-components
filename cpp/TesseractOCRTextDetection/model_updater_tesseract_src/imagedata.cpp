...
//              model_updater_tesseract_src file and its corresponding boxes or text file.
// Author:      Ray Smith
...
// Number of documents to read ahead while model_updater_tesseract_src. Doesn't need to be very
// large.

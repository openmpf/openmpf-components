...
namespace {
  ...
  std::string tritonType2Str(const inference::DataType& dt) {
    switch (dt) {
      ...
      case inference::TYPE_UINT8:   return "UINT8";
      case inference::TYPE_UINT16:  return "UINT16";
      case inference::TYPE_UINT32:  return "UINT32";
      case inference::TYPE_UINT64:  return "UINT64";
      case inference::TYPE_INT8:    return "INT8";
      case inference::TYPE_INT16:   return "INT16";
      case inference::TYPE_INT32:   return "INT32";
      case inference::TYPE_INT64:   return "INT64";
      case inference::TYPE_FP16:    return "FP16";
      case inference::TYPE_FP32:    return "FP32";
      case inference::TYPE_FP64:    return "FP64";
      case inference::TYPE_STRING:  return "STRING";
  ...
  size_t tritonTypeSizeOf(const inference::DataType& dt) {
    switch (dt) {
        ...
        case inference::TYPE_UINT16: return sizeof(u_int16_t);
        case inference::TYPE_UINT32: return sizeof(u_int32_t);
        case inference::TYPE_UINT64: return sizeof(u_int64_t);
        case inference::TYPE_INT8:   return sizeof(int8_t);
        case inference::TYPE_INT16:  return sizeof(int16_t);
        case inference::TYPE_INT32:  return sizeof(int32_t);
        case inference::TYPE_INT64:  return sizeof(int64_t);
        case inference::TYPE_FP16:   return sizeof(int16_t);
        case inference::TYPE_FP32:   return sizeof(float);
        case inference::TYPE_FP64:   return sizeof(double);
        default: return -1;
    }
  }
  ...
  size_t tritonTypeName2OCVType(const inference::DataType& dt){
    switch (dt){
      ...
      case inference::TYPE_INT16: return CV_16SC1;
      case inference::TYPE_INT32: return CV_32SC1;
